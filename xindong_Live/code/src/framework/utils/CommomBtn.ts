...
class CommomBtn {
     ...
     * @param type 声音播放类型
     */
    public static btnClick(target:egret.DisplayObject, cb:Function, thisObject:any, type:number = ComBtnType.Click) {
        if(target == null){
            return;
        }
...
class BtnClick{
    ...
    private onTouchTap(e:egret.TouchEvent){
        this.cb.call(this.thisObject, e);
    }
